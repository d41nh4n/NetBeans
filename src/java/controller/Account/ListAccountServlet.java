...
public class ListAccountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        List<Account> list = new Account().getAll();
        if (list.isEmpty()) {
            request.setAttribute("notice", "List Null!");
            request.getRequestDispatcher("PageEmployee/listaccount.jsp").forward(request, response);
        } else {
