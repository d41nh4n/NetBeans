 ...
 * @author Dai Nhan
 */
@WebServlet(name = "AddUsingRoomServlet", urlPatterns = {"/addusingroom"})
public class AddUsingRoomServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddUsingRoomServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddUsingRoomServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        usingroom.insert(new UsingRoom(roomNum, numberUser, datein, dateout, deposite, priceTotal));
